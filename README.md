...
# 📖 [Friendly Budget] <a name="about-project"></a>

> Describe your project in 1 or 2 sentences.

**[Friendly Budget]**A mobile web application where users can manage their budget: they have a list of transactions associated with a category, so that they can see how much money they spent and on what.
...
- **[Create a Category]**
- **[Create Expenditure for category]**
- **[Sign up users]**
...
```
git@github.com:Ogaga01/Budget-App.git
```
...
Feel free to check the [issues page](https://github.com/Ogaga01/Budget-App/issues).
